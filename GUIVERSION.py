...
class VoiceRecorderApp:
    def __init__(self, root):
        ...
        self.cont_button.pack(side=tk.LEFT, padx=5)
    ...
    def open_recording(self):
        # Add functionality to open recording after admin login
        pass
